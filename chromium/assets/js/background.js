...
const initialState={disabled:!1,dark_mode:!0,focus_mode:!0,bigger_navbar:!0,header_btns:!0,static_aside:!1,heart_icons:!0,block_images:!1,block_videos:!1,rect_avatars:!1,square_shaped:!1,now_play_disable:!1,theme:"purple_dark",font:"inter",timestamp:Date.now()},browser_cr=chrome||browser;function initStateIfNotExist(){browser_cr.storage.local.get("formState",e=>{e.formState&&0!==Object.keys(e.formState).length||browser_cr.storage.local.set({formState:{...initialState}})})}initStateIfNotExist(),chrome=chrome||browser,browser_cr.runtime.onInstalled.addListener(function(t){"install"!==t.reason&&"update"!==t.reason||chrome.storage.local.get("welcomePageDisplayed",function(e){e.welcomePageDisplayed||"install"!==t.reason?t.reason:(chrome.tabs.create({url:"https://weblxapplications.com/sp/welcome"}),chrome.storage.local.set({welcomePageDisplayed:!0}))})}),browser_cr.runtime.setUninstallURL("https://docs.google.com/forms/d/e/1FAIpQLScGXGlaC1KUSji5XzrVtB7PpRdoBbmRhoEVig1BPPrUY2ShKg/viewform?usp=sf_link");