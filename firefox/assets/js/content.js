...
(()=>{"use strict";{let a,t,o;const l=chrome||browser,p=["roboto","poppins","caprasimo","playfair","merriweather","noto_sans","nunito","montserrat","pixelify","gabarito","roboto_condensed","inter"],d=["matrix_purple","matrix","light_green","light_pink","light_pink_dd","kimbie_dark","red","solarized_dark","quiet_light","dottie","purple_dark","dark_pink","light_purple","dark_red","dark_yellow","dark_blue","amoled","amoled_night"];function n(e,a,n){fetch(l.runtime.getURL(e)).then(e=>e.text()).then(e=>{var t=document.getElementById(n),o=document.createElement("style");o.textContent=e,o.setAttribute("id",n),a&&!t?document.head.appendChild(o):!a&&t instanceof Node&&document.head.removeChild(t)}).catch(e=>{}),"heart_icons"===n&&(a?document.documentElement.classList.remove("heart_icons_not_active"):document.documentElement.classList.add("heart_icons_not_active"))}function r(e,o,t){n(e,o,"now_play_disable"),o?a=setInterval(function(){t.forEach(e=>{var t=localStorage.getItem(e);o&&0!=t&&localStorage.setItem(e,0)})},700):clearInterval(a)}function i(e,o){n(e,o,"static_aside"),o?t=setInterval(function(){var e,t;o&&(e=localStorage.getItem("182yfcl2wcrumva06hlhooydu:ylx-default-state-nav-bar-width"),t=localStorage.getItem("182yfcl2wcrumva06hlhooydu:ylx-sidebar-state"),localStorage.getItem("182yfcl2wcrumva06hlhooydu:library-row-mode"),400!==e&&localStorage.setItem("182yfcl2wcrumva06hlhooydu:ylx-default-state-nav-bar-width",350),1==t)&&(localStorage.setItem("182yfcl2wcrumva06hlhooydu:ylx-sidebar-state",0),window.location.reload())},700):clearInterval(t)}function s(e,t){n(e,t,"focus_mode"),t?o=setInterval(function(){t&&(1==localStorage.getItem("182yfcl2wcrumva06hlhooydu:ylx-sidebar-state")&&localStorage.setItem("182yfcl2wcrumva06hlhooydu:ylx-sidebar-state",0),localStorage.setItem("182yfcl2wcrumva06hlhooydu:items-view",0))},200):clearInterval(o)}function e(){l.storage.local.get("formState",e=>{var t,o,e=e.formState.disabled?{disabled:!0}:e.formState;n("/assets/graphs/header_btns.css",e.header_btns,"header_btns"),n("/assets/graphs/rect_avatars.css",e.rect_avatars,"rect_avatars"),n("/assets/graphs/block_images.css",e.block_images,"block_images"),n("/assets/graphs/block_videos.css",e.block_videos,"block_videos"),n("/assets/graphs/bigger_navbar.css",e.bigger_navbar,"bigger_navbar"),n("/assets/graphs/heart_icons.css",e.heart_icons,"heart_icons"),r("/assets/graphs/now_play_disable.css",e.now_play_disable,["182yfcl2wcrumva06hlhooydu:ui-panel-state","182yfcl2wcrumva06hlhooydu:ylx-sidebar-state"]),i("/assets/graphs/static_aside.css",e.static_aside),s("/assets/graphs/focus_mode.css",e.focus_mode),n("/assets/graphs/square_shaped.css",e.square_shaped,"square_shaped"),n("/assets/graphs/reduce_lowend.css",e.reduce_lowend,"reduce_lowend"),t=e.theme,-1!==d.indexOf(t)&&n(`/assets/graphs/themes/${t}.css`,!0,t),d.filter(e=>e!==t).forEach(e=>document.getElementById(e)?.remove()),o=e.font,-1!==p.indexOf(o)&&n(`/assets/graphs/fonts/${o}.css`,!0,o),p.filter(e=>e!==o).forEach(e=>document.getElementById(e)?.remove())})}l.storage.onChanged.addListener(function(){e()}),document.addEventListener("DOMContentLoaded",e,!1)}})(),(()=>{{var[o,a,e=300,n=50]=[".VUXMMFKWudUWE1kIXZoS.rwdnt1SmeRC_lhLVfIzg",e=>{var t=document.createElement("div");t.innerHTML=`
...
<style id="43ggfdbt5rf">
  ...
  button.close_btn {
    ...
    border-radius: 100px;
            ...
            `;setTimeout(()=>{document.body.appendChild(a);var e=document.querySelectorAll(".closeNotification"),e=(e&&e?.forEach(e=>e.addEventListener("click",function(){a.style.display="none"})),s.storage.local.set({closeDonateCount:1+(isNaN(n.closeDonateCount)?0:+n.closeDonateCount)}),"string"==typeof t?.formState?.theme&&s.storage.local.set({formState:{...t.formState,timestamp:Date.now()}}),document.querySelectorAll(".donate-btn"));e.length&&e.forEach(e=>e.addEventListener("click",function(){s.storage.local.set({closeDonateCount:1})}))},24e4)}})})},!1)}})();